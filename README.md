...
* Nicola - used file:///C:/Users/Nicola/Downloads/grid_editor.html to create the grids and collisions for the maps and where the player can traverse. Used ai with the grid editor to find where the collisions should take place in order to maximize efficiency for large maps with unwalkable passages.
